# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/eval/eval_scenarios_by_fleet_forecast.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: eval_scenarios_by_fleet_forecast) {')
...
# if (printOK) cat(paste(" Discard -", sep="") )                                  
