# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/economic_params/labour/labour_sorting_bk/labour_sorting.cell_edited.r'), '\n')
...
bmt_labour_sorting.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 bmt_labour_sorting.model <- data 
  ...
  bmt_fleet.labour_sorting[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_labour_sorting_list[[r]]))))
  }
