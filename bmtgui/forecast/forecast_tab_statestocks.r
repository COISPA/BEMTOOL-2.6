# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/forecast/forecast_tab_statestocks.r'), '\n')
...
# object
img_kobe_path_fore <-   paste0(mat_cfg_general[1,3],  "/", name_this_scenario  ,"/", mat_cfg_general[1,2], " - KOBE plot ",name_this_scenario,".jpg", sep="")
img_KobePlot_pb_fore <-  try(gdkPixbufNewFromFileTrim(img_kobe_path_fore), silent = TRUE)
...
try(
  ...
  if (!inherits(img_KobePlot_pb_fore,'try-error')) {
    
    img_KobePlot_pb_fore_resized <- gdkPixbufScaleSimple(img_KobePlot_pb_fore, 300, 300, "bilinear")
    img_KobePlot_fore <- gtkImageNewFromPixbuf(img_KobePlot_pb_fore_resized)
...
try(
  ...
  if (!inherits(img_KobePlot_pb_fore,'try-error')) {
    ...
    img_KobePlot_pb_fore_resized <- gdkPixbufScaleSimple(img_KobePlot_pb_fore, 400, 400, "bilinear")
    img_KobePlot_fore <- gtkImageNewFromPixbuf(img_KobePlot_pb_fore_resized)
