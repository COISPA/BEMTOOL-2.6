# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/econ/updateDerivedEffortVars.nonint.r'), '\n')
...
for (n_int in 1:n_fleet) {     
 ...
 # -------------------------------------------------------- about VESSELS
  ...
  # -------------------------------------------------------- about DAYS
   ...
   Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.average.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.annual)))/  as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual ))
   ...
   Fyear[[y_int]]@fleetsegments[[n_int]]@GT.average.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@GT.annual)))/ as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual))
   ...
   Fyear[[y_int]]@fleetsegments[[n_int]]@KW.average.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@KW.annual)))/ as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual))
   ...
   Fyear[[y_int]]@fleetsegments[[n_int]]@GT.DAYS.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@GT.annual))) * as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.average.annual))
   ...
   Fyear[[y_int]]@fleetsegments[[n_int]]@KW.DAYS.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@KW.annual))) * as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.average.annual))  
  ...
  # -------------------------------------------------------- about DAYS
   # update annual DAYS
   Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@DAYS.average.annual))) * as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual ))
  
   # -------------------------------------------------------- about GT  
   # note: all the GT variables are constant in all the simulation and forecast
   # update annual GT
   Fyear[[y_int]]@fleetsegments[[n_int]]@GT.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@GT.average.annual))) * as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual ))
   
   # -------------------------------------------------------- about KW  
   # note: all the KW variables are constant in all the simulation and forecast
      # update annual KW
   Fyear[[y_int]]@fleetsegments[[n_int]]@KW.annual <- convert_numeric0_to_na(as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@KW.average.annual))) * as.numeric(as.character(Fyear[[y_int]]@fleetsegments[[n_int]]@VESSELS.annual ))
