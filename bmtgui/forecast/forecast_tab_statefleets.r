# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/forecast/forecast_tab_statefleets.r'), '\n')
...
img_RL_pb_fore <- try(gdkPixbufNewFromFileTrim(img_RL_path_fore),silent = T)
