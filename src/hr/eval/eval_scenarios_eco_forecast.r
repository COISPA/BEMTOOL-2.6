# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/eval/eval_scenarios_eco_forecast.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: eval_scenarios_eco_forecast) {')
...
resTotLand$Value <- convert_numeric0_to_na(as.numeric(as.character(resTotLand$Value))) /1000
...
resTotRev$Value <- convert_numeric0_to_na(as.numeric(as.character(resTotRev$Value))) / 1000
