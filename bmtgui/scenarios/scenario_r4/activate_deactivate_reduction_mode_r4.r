# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/scenarios/scenario_r4/activate_deactivate_reduction_mode_r4.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: activate_deactivate_reduction_mode_r4w) {')
