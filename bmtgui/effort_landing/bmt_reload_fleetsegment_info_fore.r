# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/effort_landing/bmt_reload_fleetsegment_info_fore.r'), '\n')
...
bmt_reload_fleetsegment_info_fore<-function(w) {
  print('Calling function: bmt_reload_fleetsegment_info_forew) {')
