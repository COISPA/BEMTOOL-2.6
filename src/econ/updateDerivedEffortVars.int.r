# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/econ/updateDerivedEffortVars.int.r'), '\n')
...
# update monthly DAYS
 ...
 days_df <- data.frame(matrix( as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@DAYS.average)) * as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@VESSELS)) , nrow=1)) 
  ...
  FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@DAYS.average.annual <- convert_numeric0_to_na(as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@DAYS.annual)))/  as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@VESSELS.annual ))
   ...
   FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@GT.average.annual <- convert_numeric0_to_na(as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@GT.annual)))/ as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@VESSELS.annual))
   ...
   FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@KW.average.annual <- convert_numeric0_to_na(as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@KW.annual)))/ as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@VESSELS.annual))
   ...
   FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@GT.DAYS.annual <- convert_numeric0_to_na(as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@GT.annual))) * as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@DAYS.average.annual))
   ...
   FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@KW.DAYS.annual <- convert_numeric0_to_na(as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@KW.annual))) * as.numeric(as.character(FY[[TIME_TO_CHANGE]]@fleetsegments[[n_int]]@DAYS.average.annual))  
