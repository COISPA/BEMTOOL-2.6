# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/economic_params/indicators/indic_subsidies/indic_subsidies.cell_edited.r'), '\n')
...
bmt_indic_subsidies.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 bmt_indic_subsidies.model <- data 
  ...
  bmt_fleet.indic_subsidies[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_indic_subsidies_list[[r]]))))
  }
