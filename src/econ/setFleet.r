# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/econ/setFleet.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: setFleetFyear) {')
...
Fyear[[y_int]]@fleetsegments[[n_int]]@revenues.CI.perc[,m] <- convert_numeric0_to_na(as.numeric(as.character( Fyear[[y_int]]@fleetsegments[[n_int]]@revenues[m] )))  
