# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/casestudy/setCaseStudycfg.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: setCSnamew) {')
...
# if (printOK)   print('Calling function: assign_casestudypathw) {')
...
# if (printOK)   print('Calling function: setPeriodw) {')
...
# if (printOK)   print('Calling function: set_mat_cfg_SFmat_cfg_SF) {')
...
# if (printOK)   print('Calling function: saveBMTCFGw) {')
...
# if (printOK)   print('Calling function: save_bmtcfg_filew) {')
