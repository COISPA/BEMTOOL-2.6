# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/econ/readEconparams_fore_bk.r'), '\n')
...
option[[1]] =convert_numeric0_to_na( as.numeric( as.character(cfg[rownames(cfg) == "casestudy.priceFun",1]) ))
option[[2]] = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.varCostFun",1]) ))
option[[3]] = 1    # labour costs
option[[4]] = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.fixCostFun",1]) ))
option[[5]] = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.capCostFun",1]) ))
option[[6]] = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.fleDynFun",1]) ))
option[[7]] = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.actDynFun",1]) ))
option[[8]]  = convert_numeric0_to_na( as.numeric(as.character(cfg[rownames(cfg) == "casestudy.tecProgFun",1]) ))

option_discard_price = convert_numeric0_to_na( as.numeric( as.character(cfg[rownames(cfg) == "casestudy.priceFun",2]) ) )
