# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/effort_landing/effort.number/NUMBER.cell_edited.r'), '\n')
...
bmt_NUMBER.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 if (is.na(as.double(new.text) )) {
  ...
  bmt_fleet.NUMBER[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_NUMBER_list[[r]]))))
  }
