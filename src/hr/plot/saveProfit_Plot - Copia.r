# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/plot/saveProfit_Plot - Copia.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: saveProfit_Plotall_the_years, econind_path, econind_path_quantiles) {')
...
profit_toplot$Value <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot$Value))) / 1000
R_BER_toplot$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot$R_BER))) 

profit_toplot$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot$Year)))
R_BER_toplot$Year <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot$Year)))
...
profit_toplot_1$Value <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_1$Value))) / 1000
profit_toplot_2$Value <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_2$Value))) / 1000
profit_toplot_4$Value <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_4$Value))) / 1000
profit_toplot_5$Value <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_5$Value))) / 1000

R_BER_toplot_1$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_1$R_BER))) 
R_BER_toplot_2$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_2$R_BER))) 
R_BER_toplot_4$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_4$R_BER))) 
R_BER_toplot_5$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_5$R_BER))) 

profit_toplot$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot$Year)))
profit_toplot_1$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_1$Year)))
profit_toplot_2$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_2$Year)))
profit_toplot_4$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_4$Year)))
profit_toplot_5$Year <- convert_numeric0_to_na(as.numeric(as.character(profit_toplot_5$Year)))
...
#net.profit_toplot_inf$Value <- convert_numeric0_to_na(as.numeric(as.character(net.profit_toplot_inf$Value)))
#R_BER_toplot_inf$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_inf$R_BER)))

#net.profit_toplot_inf$Year <- convert_numeric0_to_na(as.numeric(as.character(net.profit_toplot_inf$Year)))
#R_BER_toplot_inf$Year <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_inf$Year)))
...
#
#net.profit_toplot_sup$Value <- convert_numeric0_to_na(as.numeric(as.character(net.profit_toplot_sup$Value)))
#R_BER_toplot_sup$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_sup$R_BER)))
#
#net.profit_toplot_sup$Year <- convert_numeric0_to_na(as.numeric(as.character(net.profit_toplot_sup$Year)))
#R_BER_toplot_sup$Year <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_sup$Year)))
}
