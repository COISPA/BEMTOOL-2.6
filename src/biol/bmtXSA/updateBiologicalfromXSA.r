# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtXSA/updateBiologicalfromXSA.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: updateBiologicalfromXSAdoALADYM_simulation, populs, IsY, source_obj, yy, mm, mort_const, year_interact) {')
...
IsY[[year_interact]][[mm]]@referencePoints@F0.1[2, 1] <- convert_numeric0_to_na(as.numeric(as.character(fX[1,1])))/ mean_harvest # factor
IsY[[year_interact]][[mm]]@referencePoints@F0.1[2, 2] <- convert_numeric0_to_na(as.numeric(as.character(fX[1,1]))) # F
IsY[[year_interact]][[mm]]@referencePoints@F0.1[2, 3] <- convert_numeric0_to_na(as.numeric(as.character(fX[1,2]))) # Total.yield
IsY[[year_interact]][[mm]]@referencePoints@F0.1[2, 5] <- convert_numeric0_to_na(as.numeric(as.character(fX[1,5]))) # Biomass
IsY[[year_interact]][[mm]]@referencePoints@F0.1[2, 7] <- convert_numeric0_to_na(as.numeric(as.character(fX[1,4]))) # SSB

#rp_temp_max <-  data.frame(matrix(NA, ncol=7, nrow=1))
#colnames(rp_temp_max) <- c("factor", "F", "Y", "Y_R", "B", "B_R", "SSB")
#                               # data.frame	values by items [factor, Y, Y/R, B, B/R, SSB]
IsY[[year_interact]][[mm]]@referencePoints@Fmax[2, 1] <- convert_numeric0_to_na(as.numeric(as.character(fX[2,1])))/ mean_harvest # factor
IsY[[year_interact]][[mm]]@referencePoints@Fmax[2, 2] <- convert_numeric0_to_na(as.numeric(as.character(fX[2,1]))) # F
IsY[[year_interact]][[mm]]@referencePoints@Fmax[2, 3] <- convert_numeric0_to_na(as.numeric(as.character(fX[2,2]))) # Total.yield
IsY[[year_interact]][[mm]]@referencePoints@Fmax[2, 5] <- convert_numeric0_to_na(as.numeric(as.character(fX[2,5]))) # Biomass
IsY[[year_interact]][[mm]]@referencePoints@Fmax[2, 7] <- convert_numeric0_to_na(as.numeric(as.character(fX[2,4]))) # SSB

#rp_temp_FMSY<-  data.frame(matrix(NA, ncol=7, nrow=1))
#colnames(rp_temp_FMSY) <- c("factor", "F", "Y", "Y_R", "B", "B_R", "SSB")
#                               # data.frame	values by items [factor, Y, Y/R, B, B/R, SSB]
IsY[[year_interact]][[mm]]@referencePoints@FMSY[2, 1] <- convert_numeric0_to_na(as.numeric(as.character(fX[4,1])))/ mean_harvest # factor
IsY[[year_interact]][[mm]]@referencePoints@FMSY[2, 2] <- convert_numeric0_to_na(as.numeric(as.character(fX[4,1]))) # F
IsY[[year_interact]][[mm]]@referencePoints@FMSY[2, 3] <- convert_numeric0_to_na(as.numeric(as.character(fX[4,2]))) # Total.yield
IsY[[year_interact]][[mm]]@referencePoints@FMSY[2, 5] <- convert_numeric0_to_na(as.numeric(as.character(fX[4,5]))) # Biomass
IsY[[year_interact]][[mm]]@referencePoints@FMSY[2, 7] <- convert_numeric0_to_na(as.numeric(as.character(fX[4,4]))) # SSB  
