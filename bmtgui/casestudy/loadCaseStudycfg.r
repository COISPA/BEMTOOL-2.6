# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/casestudy/loadCaseStudycfg.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: loadCaseStudycfgpath) {')
...
first_y <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(mat_cfg_general[mat_cfg_general[,1] == "casestudy.startsimulation" , 2]))))
last_y <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(mat_cfg_general[mat_cfg_general[,1] == "casestudy.endsimulation" , 2]))))    
