# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/mcda/Run_MCDA.R'), '\n')
...
Run_MCDA <- function() {
# if (printOK) if (printOK)   print('Calling function: Run_MCDA) {')
...
k_GVA_ROI_PROFITS<<- convert_numeric0_to_na(as.numeric(as.character(w[1])))
k_RBER<<- convert_numeric0_to_na(as.numeric(as.character(w[2])))
k_WAGE<<- convert_numeric0_to_na(as.numeric(as.character(w[3])))
k_EMPL<<- convert_numeric0_to_na(as.numeric(as.character(w[4])))
k_SSB<<- convert_numeric0_to_na(as.numeric(as.character(w[5])))
k_F<<- convert_numeric0_to_na(as.numeric(as.character(w[6])))
k_Y<<- convert_numeric0_to_na(as.numeric(as.character(w[7])))
k_D<<- convert_numeric0_to_na(as.numeric(as.character(w[8])))
...
u_gva_mey<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[1])))
u_gva_0.5mey<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[2])))

#u_roi_mey<-as.numeric(as.character(utility_params$Value[3]))
#u_roi_0.5mey<-as.numeric(as.character(utility_params$Value[4]))

u_rber_1<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[3])))
u_rber_1.5<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[4])))

u_empl_ce<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[5])))
u_empl_0.5ce<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[6])))

u_wage_mnw<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[7])))

u_ssb_0.2<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[8])))
u_ssb_msy<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[9])))

u_f_msy<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[10])))
u_f_2msy<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[11])))

u_y_msy<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[12])))
u_y_0.5msy<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[13])))

u_d_0.25<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[14])))
u_d_0.5<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[15])))


GVA_or_ROI_or_PROFITS<<- as.character(utility_params$Value[16])
last_values<<- convert_numeric0_to_na(as.numeric(as.character(utility_params$Value[17])))
...
ECOindicators_mcda$Value <- convert_numeric0_to_na(as.numeric(as.character(ECOindicators_mcda$Value)))
...
# Current employment if employment in the first year
    ...
    CE <- convert_numeric0_to_na(as.numeric(as.character(ECOindicators[ECOindicators$Year==years.all[1] & ECOindicators$Variable=="employment" & ECOindicators$Fleet_segment=="ALL",]$Value))) 
