# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/plot/plotEstimatedLC.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: plotEstimatedLCall_the_years, econind_path, econind_path_quantiles) {')
...
vc_toplot$Value <- convert_numeric0_to_na(as.numeric(as.character(vc_toplot$Value))) / 1000
...
vc_toplot_1$Value <- convert_numeric0_to_na(as.numeric(as.character(vc_toplot_1$Value))) / 1000
...
vc_toplot_2$Value <- convert_numeric0_to_na(as.numeric(as.character(vc_toplot_2$Value))) / 1000
...
vc_toplot_4$Value <- convert_numeric0_to_na(as.numeric(as.character(vc_toplot_4$Value))) / 1000
...
vc_toplot_5$Value <- convert_numeric0_to_na(as.numeric(as.character(vc_toplot_5$Value))) / 1000
