cat('Running script:', 'runBEMTOOLforecast.r', '\n')
# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/runBEMTOOLforecast.r'), '\n')
...
try(bmtsaveKobePlot(c(years, years.forecast), name_bioind, name_pressind))
...
try(saveRevenues_discard_Plot(c(years, years.forecast), name_econind, name_econind_CI))
