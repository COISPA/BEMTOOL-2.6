# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/economic_params/indicators/ecoind/ecoind.cell_edited.r'), '\n')
...
bmt_ecoind.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 bmt_ecoind.model <- data 
  ...
  bmt_fleet.ecoind[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_ecoind_list[[r]]))))
  }
