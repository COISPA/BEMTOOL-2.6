# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/economic_params/labour/discard_cost/discard_cost.cell_edited.r'), '\n')
...
bmt_discard_cost.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 bmt_discard_cost.model <- data 
  ...
  bmt_fleet.discard_cost[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_discard_cost_list[[r]]))))
  }
