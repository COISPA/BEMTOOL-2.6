# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/effort_landing/setEffortLanding_fleet_settings.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: setEffortLanding_fleet_settingsw) {')
index_to_update = -1
...
# if (printOK)   print('Calling function: assign_effort_vessels_pathw) {')
...
# if (printOK)   print('Calling function: assign_effort_days_pathw) {')
...
# if (printOK)   print('Calling function: assign_effort_gt_pathw) {')
...
# if (printOK)   print('Calling function: assign_effort_kw_pathw) {')
     }    
}
...
# if (printOK)   print('Calling function: assign_species_pathw) {')
}
