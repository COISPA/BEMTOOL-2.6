# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/plot/saveRevenues_Plot.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: saveRevenues_Plotall_the_years, econind_path, econind_path_quantiles) {')
...
if (phase == "FORECAST") {
ECOIndicators_quantiles <- try(read.csv(econind_path_quantiles, sep=";",header=T),silent = T)
