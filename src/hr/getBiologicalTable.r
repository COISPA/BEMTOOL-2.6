# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/getBiologicalTable.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: getBiologicalTableall_the_years) {')
...
#SSB_value <- mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@SSB)), na.rm=T)
 SSB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SSB)))
 
 if (length(SSB_value) == 0) {
   SSB_value=0
 }
...
B_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SB))) # mean(monthly_B_value, na.rm=T)
...
#B0_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SB  ))) # mean(monthly_B0_value, na.rm=T)
...
SSB0_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SSB))) # mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@SSB)), na.rm=T)
...
#ExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.numbers ))) # mean(monthly_ExplPopuNB_value, na.rm=T)
...
#unExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.numbers)))# mean(monthly_unExplPopuNB_value, na.rm=T)
...
#SS_ExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SS.numbers))) # mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@SS.numbers)), na.rm=T)
...
#SS_unExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SS.numbers))) # mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@SS.numbers)), na.rm=T)
...
if(length(Interactionsyear[[yea]][[ss]]@exploitedStock@criticalLength)==0){
  Interactionsyear[[yea]][[ss]]@exploitedStock@criticalLength=0
}
