# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/plot/saveSalary_Plot.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: saveSalary_Plotall_the_years, econind_path, econind_path_quantiles) {')
...
employment_toplot$Value <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot$Value)))
#wage_toplot$Value <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot$Value)))  /1000

employment_toplot$Year <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot$Year)))
wage_toplot$Year <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot$Year)))
...
employment_toplot_1$Value <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_1$Value))) 
wage_toplot_1$Value <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_1$Value)))  /1000

employment_toplot_2$Value <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_2$Value)))
wage_toplot_2$Value <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_2$Value))) /1000

employment_toplot_4$Value <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_4$Value)))
wage_toplot_4$Value <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_4$Value))) /1000

employment_toplot_5$Value <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_5$Value)))
wage_toplot_5$Value <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_5$Value))) /1000

employment_toplot_1$Year <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_1$Year)))
wage_toplot_1$Year <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_1$Year)))

employment_toplot_2$Year <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_2$Year)))
wage_toplot_2$Year <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_2$Year)))

employment_toplot_4$Year <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_4$Year)))
wage_toplot_4$Year <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_4$Year)))

employment_toplot_5$Year <- convert_numeric0_to_na(as.numeric(as.character(employment_toplot_5$Year)))
wage_toplot_5$Year <- convert_numeric0_to_na(as.numeric(as.character(wage_toplot_5$Year)))
...
wage_toplot$Value[which(wage_toplot$Value == Inf | wage_toplot$Value == -Inf)]<-0
