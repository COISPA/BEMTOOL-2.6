cat('Running script:', 'runBiol.fore.r', '\n')
# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/runBiol.fore.r'), '\n')
