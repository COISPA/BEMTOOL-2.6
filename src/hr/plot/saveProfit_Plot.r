# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/plot/saveProfit_Plot.r'), '\n')
...
R_BER_toplot$R_BER <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot$Value))) 
...
R_BER_toplot_1$Value <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_1$Value))) 
R_BER_toplot_2$Value <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_2$Value))) 
R_BER_toplot_4$Value <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_4$Value))) 
R_BER_toplot_5$Value <- convert_numeric0_to_na(as.numeric(as.character(R_BER_toplot_5$Value))) 
