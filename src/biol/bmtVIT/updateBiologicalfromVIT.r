# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtVIT/updateBiologicalfromVIT.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: updateBiologicalfromVITdoALADYM_simulation, populs, IsY, source_obj, yy, mm, sex, disc, mort_const, num_classes, year_interact ) {    # testare')
...
if (sex == "C" ) {
 populs[[mm]]@M.cost[1,1] <- convert_numeric0_to_na(as.numeric(as.character(populs[[mm]]@M.cost[1,1])))  + diff_Z_F[1]
 populs[[mm]]@M.cost[2,1] <- convert_numeric0_to_na(as.numeric(as.character(populs[[mm]]@M.cost[2,1]))) + diff_Z_F[1]
} else if (sex == "F" ) {
 populs[[mm]]@M.cost[2,1] <- convert_numeric0_to_na(as.numeric(as.character(populs[[mm]]@M.cost[2,1]))) + diff_Z_F[1]
} else if (sex == "M" ) {
 populs[[mm]]@M.cost[1,1] <- convert_numeric0_to_na(as.numeric(as.character(populs[[mm]]@M.cost[1,1])))  + diff_Z_F[1]
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]$catches@numbers <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]$catches@numbers))) + data.frame(numbers_temp)
}
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]$landings@numbers <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]$landings@numbers))) + data.frame(numbers_temp)
}

}

# catch in weight (total weight)
fV <- convert_numeric0_to_na(as.numeric(as.character(source_obj$ catches_w  [1:(length(source_obj$age_classes)), (2+n_fl)])))
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $catches  @totalweight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $catches  @totalweight)))  + weight_temp  
} 
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $landings  @totalweight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $landings  @totalweight)))  + weight_temp  
} 
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $catches  @meanWeight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $catches  @meanWeight)))*sexratio + (a.M * as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $catches  @meanLength ))^ b.M ) * (1-sexratio)
}
...
IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $landings  @meanWeight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $landings  @meanWeight)))*sexratio + (a.M * as.numeric(as.character(IsY[[year_interact]][[mm]]@interactions[[n_fl]]   $landings  @meanLength ))^ b.M ) * (1-sexratio)
}
...
IsY[[year_interact]][[mm]]@mortalities[nFLEET,2] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@mortalities[nFLEET,2]))) * sexratio  +  mean(as.numeric(as.character((source_obj$ VPA_results_mortalities  [which(source_obj$ VPA_results_mortalities$Class == which(source_obj$age_classes == minAge)): which(source_obj$ VPA_results_mortalities$Class == which(source_obj$age_classes == maxAge)), (3+n_fl)])))) * (1-sexratio) #F  
}
...
fV <- convert_numeric0_to_na(as.numeric(as.character((source_obj$ critical_length  [1, 3]))))
IsY[[year_interact]][[mm]]@exploitedStock @criticalLength <-  fV     

# stock in number
if ( length(source_obj$age_classes) == num_classes  | (num_classes_real - length(source_obj$age_classes) )<0) {
  fV <- convert_numeric0_to_na(as.numeric(as.character(source_obj$ VPA_results_nb  [1:(length(source_obj$age_classes)), 3])))
} else {
...
IsY[[year_interact]][[mm]]@exploitedStock @SSB  <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@exploitedStock@SSB))) + SSB_temp/1000000 
}   
...
IsY[[year_interact]][[mm]]@exploitedStock @meanLength <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@exploitedStock @meanLength))) * sexratio + fV * (1- sexratio)
}
...
# stock in weight (SB) 
if ( length(source_obj$age_classes) == num_classes | (num_classes_real - length(source_obj$age_classes) )<0) {
fV <- convert_numeric0_to_na(as.numeric(as.character(source_obj$ VPA_results_w  [1:(length(source_obj$age_classes)), 3]))) 
} else {
...
IsY[[year_interact]][[mm]]@totalcatch@numbers <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totalcatch@numbers))) + data.frame(numbers_temp)
}
...
IsY[[year_interact]][[mm]]@totallanding@numbers <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totallanding@numbers))) + data.frame(numbers_temp)
}
...
# catch in weight (total weight)
fV <- convert_numeric0_to_na(as.numeric(as.character(source_obj$ catches_w  [1:(length(source_obj$age_classes)), (2)])))
weight_temp <-   sum( fV )/ 1000000
...
IsY[[year_interact]][[mm]]@totalcatch @totalweight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totalcatch @totalweight)))  + weight_temp  
} 
...
IsY[[year_interact]][[mm]]@totallanding @totalweight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totallanding @totalweight)))  + weight_temp  
}
...
IsY[[year_interact]][[mm]]@totalcatch  @meanWeight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totalcatch @meanWeight))) * sexratio + (a.M * as.numeric(as.character(IsY[[year_interact]][[mm]]@totalcatch  @meanLength ))^ b.M ) * (1-sexratio)
}
...
IsY[[year_interact]][[mm]]@totallanding  @meanWeight <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totallanding @meanWeight))) * sexratio + (a.M * as.numeric(as.character(IsY[[year_interact]][[mm]]@totallanding  @meanLength ))^ b.M ) * (1-sexratio)
}
...
fV <- convert_numeric0_to_na(as.numeric(as.character((source_obj$ critical_length  [2, 3]))))
if (sex != "M") {
IsY[[year_interact]][[mm]]@unexploitedStock @criticalLength <-  fV 
} else {
IsY[[year_interact]][[mm]]@unexploitedStock @criticalLength <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@unexploitedStock @criticalLength))) * sexratio +  fV* (1-sexratio) 
} 
...
IsY[[year_interact]][[mm]]@meanLength_catches <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@totalcatch  @meanLength )))
...
# mean_totalF_ <-  mean(as.numeric(as.character((source_obj$ VPA_results_mortalities  [((minAge+1):(maxAge+1)), 3]))))  
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 2] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 2])))*sexratio + (as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",2])) * mean_totalF_  )*(1-sexratio)

# IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 1] <- as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",2]))
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 1] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 2]  ))) / mean_totalF_ 

IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 3] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 3]))) + (as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",3])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 ) # Y
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 4] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 4]))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",3]))
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 5] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 5] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",4])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 # B
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 6] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 6] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",4]))
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 7] <- convert_numeric0_to_na(as.numeric(as.character( IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 7] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",5])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 # SSB
IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 10] <- convert_numeric0_to_na(as.numeric(as.character( IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 10] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",5]))
 }
...
# weighted mean for overall (M+F)
# mean_totalF_ <-  mean(as.numeric(as.character((source_obj$ VPA_results_mortalities  [((minAge+1):(maxAge+1)), 3]))))  
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 2] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 2])))*sexratio + (as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",2])) * mean_totalF_  )*(1-sexratio)

# IsY[[year_interact]][[mm]]@referencePoints@F0.1[1, 1] <- as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "F(0.1)",2]))
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 1] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 2]  ))) / mean_totalF_ 

IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 3] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 3]))) + (as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",3])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 ) # Y
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 4] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 4]))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",3]))
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 5] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 5] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",4])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 # B
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 6] <- convert_numeric0_to_na(as.numeric(as.character(IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 6] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",4]))
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 7] <- convert_numeric0_to_na(as.numeric(as.character( IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 7] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",5])) *  as.numeric(as.character(source_obj$ VPA_results_nb[1,2])) / 1000000 # SSB
IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 10] <- convert_numeric0_to_na(as.numeric(as.character( IsY[[year_interact]][[mm]]@referencePoints@Fmax[1, 10] ))) + as.numeric(as.character(source_obj$ reference_points[source_obj$ reference_points[,1] == "Max(:)",5]))
}
