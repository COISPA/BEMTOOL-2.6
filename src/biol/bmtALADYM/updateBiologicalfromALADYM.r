# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/updateBiologicalfromALADYM.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: updateBiologicalfromALADYMALADYM_spe, Populs, Inters, Fleet, ALADYM_rp_calc) {')
...
for (yy in 1:simperiod) {
     ...
     # exploited stock
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@L95 <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$ex_stock_L0_95[yy])))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@criticalLength <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$Critical_length_expl_pop[yy])))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@meanLength <- convert_numeric0_to_na(as.numeric(as.character(population_tbl$Mean_length_of_exploited_pop[yy])))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@harvestRate <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$Harvest_ratio[yy] )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@exploitationRate <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$Exploitation_rate[yy])))
     ...
     # unexploited stock
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@L95 <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$unex_stock_L0_95[yy] )))
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@criticalLength <- convert_numeric0_to_na(as.numeric(as.character(indicators_tbl$Critical_length_unexpl_pop[yy] )))
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@meanLength <- convert_numeric0_to_na(as.numeric(as.character(population_tbl$Mean_length_of_unexploited_pop[yy] )))
	 ...
	 Inters[[yy]][[ALADYM_spe]]@L95_catches.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@L95_catches  )))
     ...
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@L95.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@L95 )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@criticalLength.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@criticalLength )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@meanLength.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@meanLength )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@harvestRate.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@harvestRate ))) 	
     ...
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@meanWeight.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@meanWeight )))   	 
	   Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SB.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SB )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SSB.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character( Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SSB )))
 	   Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.numbers.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.numbers )))
     Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SS.numbers.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character( Inters[[yy]][[ALADYM_spe]]@exploitedStock@annual.SS.numbers )))
     ...
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@meanWeight.CI.perc[1,] <-  Inters[[yy]][[ALADYM_spe]]@unexploitedStock@meanWeight
     	   ...
     	   Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SB.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SB )))
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SSB.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character( Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SSB )))
 	   Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.numbers.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character(Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.numbers )))
     Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SS.numbers.CI.perc[1,] <- convert_numeric0_to_na(as.numeric(as.character( Inters[[yy]][[ALADYM_spe]]@unexploitedStock@annual.SS.numbers )))
}
