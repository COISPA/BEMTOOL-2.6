# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/effort_landing/setEffortLanding_fleet_settings_fore.r'), '\n')
...
setEffortLanding_fleet_settings_fore <- function(w) {
   print('Calling function: setEffortLanding_fleet_settings_forew) {')
...
# if (printOK)   print('Calling function: assign_effort_vessels_path_forew) {')
...
# if (printOK)   print('Calling function: assign_effort_days_path_forew) {')
