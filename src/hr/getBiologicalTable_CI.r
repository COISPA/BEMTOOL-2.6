# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/getBiologicalTable_CI.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: getBiologicalTable_CI) {')
...
population_table_percentiles <- suppressWarnings(try(read.table(paste(POPULATION_table_CI, " quantiles.csv", sep=""),header=TRUE,sep=";"),silent = T) )
...
SSB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SSB.CI.perc[1,PERC])))
...
B_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SB.CI.perc[1,PERC])))
...
# B(0) ---------------------------------------------------------------------------------------------------------------------
#B0_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SB.CI.perc[1,PERC])))
...
SSB0_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SSB.CI.perc[1,PERC] )))
...
#ExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.numbers.CI.perc[1,PERC] ))) # mean(monthly_ExplPopuNB_value, na.rm=T)
...
#unExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.numbers.CI.perc[1,PERC])))# mean(monthly_unExplPopuNB_value, na.rm=T)
...
#SS_ExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@annual.SS.numbers.CI.perc[1,PERC]))) # mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@exploitedStock@SS.numbers)), na.rm=T)
...
#SS_unExplPopuNB_value <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@annual.SS.numbers.CI.perc[1,PERC]))) # mean(as.numeric(as.character(Interactionsyear[[yea]][[ss]]@unexploitedStock@SS.numbers)), na.rm=T)
