# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/runTrafficLights.r'), '\n')

runTrafficLights<- function(w) {
# if (printOK) if (printOK)   print('Calling function: runTrafficLightsw) {')
