# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/ini/stocks.ini.r'), '\n')
...
lifespan_F <<- convert_numeric0_to_na(as.numeric(as.character(Populations[[ALADYM_spe]]@lifespan$lifespan[[2]])))
