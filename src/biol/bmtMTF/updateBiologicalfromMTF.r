# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtMTF/updateBiologicalfromMTF.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: updateBiologicalfromMTFInters) { ')
...
num_classes <- convert_numeric0_to_na(as.numeric(as.character(Populations[[MTF_spe]]@lifespan[2,1] )))
}
} else {
...
life_span <- convert_numeric0_to_na(as.numeric(as.character(Populations[[MTF_spe]]@lifespan[2,1] )))
