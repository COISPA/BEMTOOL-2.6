# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/economic_params/behaviour/behav_dyn/behav_dyn.cell_edited.r'), '\n')
...
bmt_behav_dyn.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 bmt_behav_dyn.model <- data 
  ...
  bmt_fleet.behav_dyn[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_behav_dyn_list[[r]]))))
  }
