# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/utils/showQuestionYN_forecast.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: showQuestionYN_forecast) {')
...
# if (printOK)   print('Calling function: QuestionYN_forecast_NOw) {')
QuestionYN_forecast_NO<-function(w) {
     error_window$destroy()
}


# if (printOK)   print('Calling function: QuestionYN_forecast_YESw) {')
