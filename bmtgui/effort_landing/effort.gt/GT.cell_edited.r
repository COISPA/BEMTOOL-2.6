# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/effort_landing/effort.gt/GT.cell_edited.r'), '\n')
...
bmt_GT.cell_edited <- function(cell, path.string, new.text, data) {
  ...
  bmt_fleet.GT[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(bmt_GT_list[[r]]))))
  }
    }
}
