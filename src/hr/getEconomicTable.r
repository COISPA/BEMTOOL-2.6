# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/getEconomicTable.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: getEconomicTableall_the_years) {')
...
var1 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@VESSELS.annual )))       
...
var2 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@GT.average.annual  ))) 
...
var3 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@GT.annual  ))) 
...
# var4 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@GT     )))					# non necessario
...
var5 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@KW.average.annual      )))
...
var6 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@KW.annual )))
...
# var7 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@KW     )))					# non necessario
...
var8 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@DAYS.average.annual   )))
...
var9 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@DAYS.annual    )))
...
var10 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@MAXDAYS.average.annual )))
...
var11 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@GT.DAYS.annual    )))
...
var12 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@KW.DAYS.annual   )))
...
var13 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.landings   )))
...
var13_discard <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.discards   )))
...
var14 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.revenues.landings   )))
...
var14_discard <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.revenues.landed_discard   )))
...
var15 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@other.income   )))
...
var16 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.income   )))
...
var17 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost$tot.var.cost[1]  )))
...
var18 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost$fuel.cost[1]   )))
...
var19 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost$commercial.cost[1]   )))
...
var20 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost$other.var.cost[1]  )))
...
var21 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fuel.price                 )))
...
var22 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$tot.fix.cost[1]   )))
...
var23 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$maint.cost[1]    ))) 
...
var24 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$other.fix.cost[1]    )))  
...
var25 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$ess.cost[1]        )))  
...
var26 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$avoid.main.cost[1]  )))  
...
var27 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$unavoid.main.cost[1]  ))) 
...
var27_bis <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost$new.equipment.cost[1]  ))) 
...
var28 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@labour.cost       )))            
...
var29 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@capital.cost$tot.cap.cost[1]  )))
...
var30 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@capital.cost$depreciation[1] ))) 
...
var31 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@capital.cost$interest[1]    )))  
...
var32 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.cost            )))     
...
var33 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@gross.value.added     )))  
...
var34 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@gross.cash.flow     )))   
...
var35 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@profit             )))    
...
var36 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@investment$number[1]   )))
...
var37 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@investment$value[1]  )))  
...
var38 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@capital.value     )))   
...
var39 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@taxes           )))     
...
var40 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@net.profit    )))     
...
var41 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@employment     )))    
...
var42 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@average.wage    )))   
...
var43 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@technology      )))    
...
var44 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.BER ))) 
...
var45 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.ROI            )))   
...
var46 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.NPV.discounted        )))   
...
var47 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.landings.day )))  
...
var48 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.landings.vessel )))
...
var49 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.revenues.day )))     
...
var50 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.revenues.vessel  ))) 
...
var51 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.GVA.vessel    )))    
...
var52 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.GCF.vessel      ))) 
...
var53 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.profit.vessel   )))  
...
var54 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.net.profit.vessel ))) 
...
var54_1 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.R_BER ))) 
...
var54_2 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.vessel.util.ratio )))
...
var54_3 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.RoFTA )))  
...
var54_4 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.NP.cap.value )))  
...
#  temp_indicators_fleet_overall <- rbind(temp_indicators_fleet_overall, to_add46_tot) 
  ...
  temp_indicators_fleet_overall <- rbind(temp_indicators_fleet_overall, to_add55_tot)
    ...
    var42_tot <- convert_numeric0_to_na(as.numeric(as.character(var28_tot)))/as.numeric(as.character(var41_tot))
...
#        
        var45_tot <- convert_numeric0_to_na(as.numeric(as.character(var35_tot)))/as.numeric(as.character(var38_tot))
    to_add45_tot <- data.frame( cbind("Economic.indicators[ROI]", cbind(ifelse(length(var45_tot) ==0, -1, round(var45_tot,numb_digits)), "") ) , stringsAsFactors=F)  
     ...
     var47_tot <- convert_numeric0_to_na(as.numeric(as.character(var13_tot)))/as.numeric(as.character(var9_tot))   
    ...
    var48_tot <- convert_numeric0_to_na(as.numeric(as.character(var13_tot)))/as.numeric(as.character(var1_tot))    
    to_add48_tot <- data.frame( cbind("Economic.indicators[tot.landings.vessel]", cbind(ifelse(length(var48_tot) ==0, -1, round(var48_tot,numb_digits)), "kg") ) , stringsAsFactors=F)  
        ...
        var49_tot <- convert_numeric0_to_na(as.numeric(as.character(var14_tot)))/as.numeric(as.character(var9_tot))
    to_add49_tot <- data.frame( cbind("Economic.indicators[tot.revenues.day]", cbind(ifelse(length(var49_tot) ==0, -1, round(var49_tot,numb_digits)), "'''?'''") ) , stringsAsFactors=F)  
        ...
        var50_tot <- convert_numeric0_to_na(as.numeric(as.character(var14_tot)))/as.numeric(as.character(var1_tot))    
    to_add50_tot <- data.frame( cbind("Economic.indicators[tot.revenues.vessel]", cbind(ifelse(length(var50_tot) ==0, -1, round(var50_tot,numb_digits)), "'''?'''") ) , stringsAsFactors=F) 
      ...
      var51_tot <- convert_numeric0_to_na(as.numeric(as.character(var33_tot)))/as.numeric(as.character(var1_tot))  
    to_add51_tot <- data.frame( cbind("Economic.indicators[GVA.vessel]", cbind(ifelse(length(var51_tot) ==0, -1, round(var51_tot,numb_digits)), "'''?'''") ) , stringsAsFactors=F)  
      ...
      var52_tot <- convert_numeric0_to_na(as.numeric(as.character(var34_tot)))/as.numeric(as.character(var1_tot))  
    to_add52_tot <- data.frame( cbind("Economic.indicators[GCF.vessel]", cbind(ifelse(length(var52_tot) ==0, -1, round(var52_tot,numb_digits)), "'''?'''") ) , stringsAsFactors=F) 
        ...
        var53_tot <- convert_numeric0_to_na(as.numeric(as.character(var35_tot)))/as.numeric(as.character(var1_tot))
    to_add53_tot <- data.frame( cbind("Economic.indicators[profit.vessel]", cbind(ifelse(length(var53_tot) ==0, -1, round(var53_tot,numb_digits)), "'''?'''") ) , stringsAsFactors=F)  
        ...
        var54_tot <- convert_numeric0_to_na(as.numeric(as.character(var40_tot)))/as.numeric(as.character(var1_tot))
...
year_name_in_row <-  ifelse(yy<=simperiod, years[yy], years.forecast[yy-simperiod])
  ...
  for (m_int in 1:length(BMT_SPECIES) ) {         
    ...
    for (n_int in 1:length(BMT_FLEETSEGMENTS)) {
          ...
          varsp1 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@landing.weight[m_int] )))
          varsp2 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@landing.number[m_int])))
          varsp5 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@discard.weight[m_int] )))
          varsp6 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@discard.number[m_int])))
          varsp3 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@price[m_int]    )))
         varsp4 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@revenues.landing[m_int]  )))
          
           varsp7 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@price.landed_discard[m_int]    )))
                    varsp8 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@revenues.landed_discard[m_int]    )))
...
if (phase =="FORECAST" ) {
 ...
 var46_a <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[foreperiod]]@fleetsegments[[n_int]]@EC.NPV15         )))   
...
colnames(to_add46_a) <- head_table
 ...
 var46_b <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[foreperiod]]@fleetsegments[[n_int]]@EC.NPV15.infinite         )))   
