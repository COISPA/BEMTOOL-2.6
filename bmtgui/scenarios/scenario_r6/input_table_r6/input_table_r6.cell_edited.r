# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/scenarios/scenario_r6/input_table_r6/input_table_r6.cell_edited.r'), '\n')
...
input_table_r6.cell_edited <- function(cell, path.string, new.text, data) {
 ...
 input_table_r6.model <- data 
  ...
  input_table_r6[r,] <<- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(input_table_r6_list[[r]]))))
  }
