# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/utils/showQuestionYN_diagnosis.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: showQuestionYN_diagnosis) {')
...
# if (printOK)   print('Calling function: QuestionYN_diagnosis_NOw) {')
QuestionYN_diagnosis_NO<-function(w) {
     error_window$destroy()
}


# if (printOK)   print('Calling function: QuestionYN_diagnosis_YESw) {')
