# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/hr/getEconomicTable_CI.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: getEconomicTable_CI) {')
...
production_table_percentiles <- try(read.table(paste(PRODUCTION_table_CI, " quantiles.csv", sep=""),header=TRUE,sep=";"),silent = T )
...
var13 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.landings.CI.perc   )))
...
var13_discard <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.discards.CI.perc   )))
...
var14 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.revenues.CI.perc   )))
...
var14_land <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.revenues.landings.CI.perc   )))
...
var14_disc <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.revenues.landed_discard.CI.perc   )))
...
var17 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost.CI.perc$tot.var.cost  )))
...
var18 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost.CI.perc$fuel.cost   )))
...
var19 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost.CI.perc$commercial.cost   )))
...
var20 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@variable.cost.CI.perc$other.var.cost  )))
...
var22 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$tot.fix.cost   )))
...
var23 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$maint.cost    ))) 
...
var24 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$other.fix.cost   )))  
...
var25 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$ess.cost        )))  
...
var26 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$avoid.main.cost  )))  
...
var27 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$unavoid.main.cost  ))) 
...
var27_bis <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@fixed.cost.CI.perc$new.equipment.cost  ))) 
...
var28 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@labour.cost.CI.perc       )))            
...
var32 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@total.cost.CI.perc            )))     
...
var33 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@gross.value.added.CI.perc     )))  
...
var34 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@gross.cash.flow.CI.perc     )))   
...
var35 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@profit.CI.perc             )))    
...
var36 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@investment.CI.perc$number   )))
...
var37 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@investment.CI.perc$value  )))  
...
var38 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@capital.value.CI.perc     )))   
...
var40 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@net.profit.CI.perc    )))     
...
var41 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@employment.CI.perc     )))    
...
var42 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@average.wage.CI.perc    )))   
...
var44 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.BER.CI.perc ))) 
...
var45 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.ROI.CI.perc            )))   
...
var46 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.NPV.discounted.CI.perc        )))   
...
var47 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.landings.day.CI.perc )))  
...
var48 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.landings.vessel.CI.perc )))
...
var49 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.revenues.day.CI.perc )))     
...
var50 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.tot.revenues.vessel.CI.perc  ))) 
...
var51 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.GVA.vessel.CI.perc    )))    
...
var52 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.GCF.vessel.CI.perc      ))) 
...
var53 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.profit.vessel.CI.perc   )))  
...
var54 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.net.profit.vessel.CI.perc ))) 
...
var54_1 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.R_BER.CI.perc ))) 
...
var54_2 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.vessel.util.ratio.CI.perc )))
...
var54_3 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.RoFTA.CI.perc )))  
...
var54_4 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@EC.NP.cap.value.CI.perc )))  
...
to_add14_tot_disc <- data.frame( cbind(rep("total.revenues.discard", n=5), cbind( round(var14_tot_disc,numb_digits), cbind(rep("''?''", n=5), percentiles_numb)) ) , stringsAsFactors=F) 
 ...
 # var44_tot <- sum(as.numeric(as.character(var22_tot)),as.numeric(as.character(var29_tot)), na.rm=T)/ (1-(  sum(as.numeric(as.character(var28_tot)), as.numeric(as.character(var17_tot)) ,  as.numeric(as.character(var23_tot)) , na.rm=T) /sum(as.numeric(as.character(var14_tot)) ,as.numeric(as.character(var14_tot_discard )), na.rm=T) ))
    ...
    ROFTA_with_NP_all <- convert_numeric0_to_na(as.numeric(as.character(var40_tot)))/as.numeric(as.character(var38_tot))
...
if (class(production_table_percentiles) != "try-error") {
    ...
    for (n_int in 1:length(BMT_FLEETSEGMENTS)) {
          ...
          varsp1 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@landing.weight.CI.perc[,m_int] )))
          varsp2 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@landing.number.CI.perc[,m_int])))
          varsp5 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@discard.weight.CI.perc[,m_int] )))
          varsp6 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@discard.number.CI.perc[,m_int])))
          varsp3 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@price.CI.perc[,m_int]    )))
          varsp4 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@revenues.landing.CI.perc[,m_int]  )))
 varsp7 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@price.landed_discard.CI.perc[,m_int]   )))
varsp8 <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[yy]]@fleetsegments[[n_int]]@revenues.landed_discard.CI.perc[,m_int]    )))
 ...
 var46_a <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[foreperiod]]@fleetsegments[[n_int]]@EC.NPV15.CI.perc         )))   
...
colnames(to_add46_a) <- head_table
 ...
 var46_b <- convert_numeric0_to_na(as.numeric(as.character(Fleetyear[[foreperiod]]@fleetsegments[[n_int]]@EC.NPV15.infinite.CI.perc         )))   
...
#table_output$Value <- convert_numeric0_to_na(as.numeric(as.character(table_output$Value)))
...
#table_output_past_perc$Value <- convert_numeric0_to_na(as.numeric(as.character(table_output_past_perc$Value)))
