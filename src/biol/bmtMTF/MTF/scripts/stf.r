...
stf= function(object, nyears=3, wts.nyears=3, fbar.nyears=wts.nyears, f.rescale=FALSE,
...
## stf(FLBiol) {{{
    ...
    stf_b=      function(object, nyears=3, wts.nyears=3, arith.mean=TRUE, na.rm=TRUE,
