# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtVIT/getVIToutput.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: getVIToutputVITpath, n_ages, n_fleet) {')
...
first_age <- convert_numeric0_to_na(as.numeric(as.character(VITmatrix[2,2])))
