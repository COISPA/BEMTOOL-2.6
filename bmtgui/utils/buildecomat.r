# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/bmtgui/utils/buildecomat.r'), '\n')
...
mat_cfg_labCosts  <<- data.frame(matrix("0", nrow=(2+ length(BMT_FLEETSEGMENTS)+1), ncol=(length(labcost_cfg_names)+1)), stringsAsFactors=F)
      ...
      mat_cfg_labCosts[,]=""
      mat_cfg_labCosts[1,2] <- "[model]"
mat_cfg_labCosts[2,2] <-1
mat_cfg_labCosts[3,2:ncol(mat_cfg_labCosts)] <- labcost_cfg_names
