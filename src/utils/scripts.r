# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/utils/scripts.r'), '\n')
...
source(paste(getwd(), "/src/biol/bmtMTF/MTF/scripts/stf.r", sep=""))##!!!!
